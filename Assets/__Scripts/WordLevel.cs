...
public class WordLevel //WordLevel does NOT extend MonoBehaviour
{
	...
	//A Dictionary<,> of all the letters in a word
	...
	//A static function that counts the instances of chars in a string and returns
	//a Dictionary<char, int> that contains this information
	...
	//This static method checks to see whether the word can be spelled with the chars
	//in level.charDict
